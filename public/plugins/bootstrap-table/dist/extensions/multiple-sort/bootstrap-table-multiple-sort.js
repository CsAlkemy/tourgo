    ...
    (function ($) {
        ...
        var showSortModal = function showSortModal(that) {
            ...
            if (!$(_id).hasClass("modal")) {
                var sModal = '  <div class="popup fade" id="' + _selector + '" tabindex="-1" role="dialog" aria-labelledby="' + _selector + 'Label" aria-hidden="true">';
                sModal += '         <div class="popup-dialog">';
                sModal += '             <div class="popup-content">';
                sModal += '                 <div class="popup-header">';
                sModal += '                     <button type="button" class="close" data-dismiss="popup" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
                sModal += '                     <h4 class="popup-title" id="' + _selector + 'Label">' + that.options.formatMultipleSort() + '</h4>';
                sModal += '                 </div>';
                sModal += '                 <div class="popup-body">';
                ...
                sModal += '                     </div>';
                sModal += '                 </div>';
                sModal += '                 <div class="popup-footer">';
                sModal += '                     <button type="button" class="btn btn-default" data-dismiss="popup">' + that.options.formatCancel() + '</button>';
        ...
        BootstrapTable.prototype.initToolbar = function () {
            ...
            if (this.options.showMultiSort) {
                ...
                if (!$multiSortBtn.length && this.options.showMultiSortButton) {
                    $multiSortBtn = '  <button class="multi-sort btn btn-default' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" data-toggle="popup" data-target="' + sortModalId + '" title="' + this.options.formatMultipleSort() + '">';
