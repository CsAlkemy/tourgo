...
var ModalUI = /** @class */ (function () {
    function ModalUI($node, options) {
        ...
        this.$modal = $node;
        this.$backdrop = $('<div class="note-popup-backdrop" />');
    }
    ModalUI.prototype.show = function () {
        ...
        this.$modal.trigger('note.popup.show');
        this.$modal.off('click', '.close').on('click', '.close', this.hide.bind(this));
    };
    ModalUI.prototype.hide = function () {
        this.$modal.removeClass('open').hide();
        this.$backdrop.hide();
        this.$modal.trigger('note.popup.hide');
    };
    return ModalUI;
}());
...
var dialog = renderer.create('<div class="note-popup" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
    if (options.fade) {
        $node.addClass('fade');
    }
    $node.attr({
    ...
    $node.html([
        ...
        (options.title
            ? '    <div class="note-popup-header">' +
                ...
                '      <h4 class="note-popup-title">' + options.title + '</h4>' +
                '    </div>' : ''),
        '    <div class="note-popup-body">' + options.body + '</div>',
        (options.footer
            ? '    <div class="note-popup-footer">' + options.footer + '</div>' : ''),
        '  </div>'
    ].join(''));
...
var ui = {
    ...
    onDialogShown: function ($dialog, handler) {
        $dialog.one('note.popup.show', handler);
    },
    onDialogHidden: function ($dialog, handler) {
        $dialog.one('note.popup.hide', handler);
    },
    ...
    getDialogBody: function ($dialog) {
        return $dialog.find('.note-popup-body');
    },
...
var HelpDialog = /** @class */ (function () {
    ...
    HelpDialog.prototype.initialize = function () {
        ...
        this.$dialog = this.ui.dialog({
            ...
            footer: body,
            callback: function ($node) {
                $node.find('.popup-body,.note-popup-body').css({
                    'max-height': 300,
                    'overflow': 'scroll'
                });
            }
