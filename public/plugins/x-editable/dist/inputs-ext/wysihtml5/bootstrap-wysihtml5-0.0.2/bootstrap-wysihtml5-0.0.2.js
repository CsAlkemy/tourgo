!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-popup popup hide fade'>" +
                "<div class='popup-header'>" +
                  "<a class='close' data-dismiss='popup'>&times;</a>" +
                ...
                "<div class='popup-footer'>" +
                  "<a href='#' class='btn' data-dismiss='popup'>" + locale.link.cancel + "</a>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-popup popup hide fade'>" +
                "<div class='popup-header'>" +
                  "<a class='close' data-dismiss='popup'>&times;</a>" +
                ...
                "<div class='popup-footer'>" +
                  ...
                  "<a href='#' class='btn btn-primary' data-dismiss='popup'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
