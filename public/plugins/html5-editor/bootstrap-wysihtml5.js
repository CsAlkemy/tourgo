!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-popup popup fade bs-example-popup-lg'>" +
                "<div class='popup-dialog popup-lg'>" +
					"<div class='popup-content'>" +
				"<div class='popup-header'>" +
                  "<a class='close' data-dismiss='popup'></a>" +
                ...
                "<div class='popup-footer'>" +
                  "<a href='#' class='btn btn-inverse' data-dismiss='popup'>" + locale.link.cancel + "</a>" +
                  "<a href='#' class='btn btn-primary' data-dismiss='popup'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
			  "</div>" +
              "</div>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-popup popup fade bs-example-popup-lg'>" +
                "<div class='popup-dialog popup-lg'>" +
					"<div class='popup-content'>" +
				"<div class='popup-header'>" +
                  "<a class='close' data-dismiss='popup'></a>" +
				...
				"</div>" +
                "<div class='popup-footer'>" +
                  "<a href='#' class='btn' data-dismiss='popup'>" + locale.image.cancel + "</a>" +
                  "<a href='#' class='btn  green btn-primary' data-dismiss='popup'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
			  "</div>" +
              "</div>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            var self = this;
            var insertImageModal = toolbar.find('.bootstrap-wysihtml5-insert-image-popup');
            ...
            toolbar.find('a[data-wysihtml5-command=insertImage]').click(function() {
                ...
                if (!activeButton) {
                    ...
                    insertImageModal.on('click.dismiss.popup', '[data-dismiss="popup"]', function(e) {
                        e.stopPropagation();
                    });
                    return false;
                }
        ...
        initInsertLink: function(toolbar) {
            var self = this;
            var insertLinkModal = toolbar.find('.bootstrap-wysihtml5-insert-link-popup');
            ...
            toolbar.find('a[data-wysihtml5-command=createLink]').click(function() {
                ...
                if (!activeButton) {
                    ...
                    insertLinkModal.on('click.dismiss.popup', '[data-dismiss="popup"]', function(e) {
                        e.stopPropagation();
                    });
                    return false;
                }
